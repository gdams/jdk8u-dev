...
# MANUAL
#
# ./make/scripts/compare-objects.sh old_jdk_build_dir new_jdk_build_dir
#
# Compares object files
#

if [ "x$1" = "x-h" ] || [ "x$1" = "x--help" ] || [ "x$1" == "x" ]; then
    echo "bash ./make/scripts/compare-objects.sh old_jdk_build_dir new_jdk_build_dir <pattern>"
    echo ""
